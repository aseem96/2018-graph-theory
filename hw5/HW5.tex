...
Let $H$ be the smallest component of $G$. Since $G-T$ is disconnected, it has at least two components. Therefore, $H$ contains at least $(n-k+1)/2$ vertices. \\
...
(A) edge[] node[left] {10 (12)} (D)
(B) edge[] node[left] {10 (10)} (E)
(B) edge[] node[left] {5 (5)} (F)
(C) edge[] node[left] {0 (3)} (D)
(D) edge[] node[left] {5 (5)} (E)
(E) edge[] node[left] {3 (4)} (F)
(C) edge[bend left=10] node[right] {0 (25)} (G)
(G) edge[bend left=10] node[left] {18 (25)} (C)
(D) edge[] node[left] {5 (5)} (G)
(E) edge[] node[left] {12 (12)} (G)
(F) edge[bend left=10] node[left] {1 (3)} (G)
(G) edge[bend left=10] node[right] {0 (3)} (F)
(C) edge[] node[right] {27 (40)} (H)
