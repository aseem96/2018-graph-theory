...
In every network, the maximum feasible flow is equivalent to the minimum capacity of a source/sink cut by Corollary 4.3.8. The maximum feasible flow in this case is 34, because the edge cut \{Tank1, Tank2, B\} and \{A, C, D, E, F\} produces the minimum capacity 34. Every other cut has a greater capacity, and all edge from \{Tank1, Tank2, B\} to  \{A, C, D, E, F\} have excess capacity, and no edge from  \{A, C, D, E, F\} to \{Tank1, Tank2, B\}  has nonzero flow, this must be the maximum flow possible.\\
