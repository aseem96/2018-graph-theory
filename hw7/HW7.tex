...
\begin{question}{3}
 6.1.29  Prove that the complement of a simple planar graph with at least 11 vertices is nonplanar.  Construct a self-complementary simple panar graph with 8 vertices.
\end{question}
